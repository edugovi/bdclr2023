...
<html lang="<?php echo get_html_lang(); ?>" prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <?php
        queue_css_file(array('bdcdl-2020'), 'all', false, 'css', $version = '0.4.3');
        echo head_css();
        ?>
        <script src='https://www.google.com/recaptcha/api.js' async defer></script>
        
        <?php
        queue_js_file(array('bootstrap.bundle.min', 'bdcdl'), 'javascripts', array(), '0.4.3');
        echo head_js();
        ?>
		<script>
        ...
        <nav class="navbar bg-body-tertiary fixed-top bg-dark navbar-dark" data-bs-theme="dark">
            <div class="container-fluid">
                ...
                echo link_to_home_page(
                    '<img height="30" style="margin-right: 15px;" src="' .
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><?php echo $siteTitle; ?></h5>
                    ...
                    <div class="offcanvas-body">
                        ...
                        <form class="d-flex mt-3" role="search" action="<?php echo url('search'); ?>" method="get">
